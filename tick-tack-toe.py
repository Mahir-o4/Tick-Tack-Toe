...
current_player='X'
non_player='O'
box={1:[0,0],2:[0,1],3:[0,2],4:[1,0],5:[1,1],6:[1,2],7:[2,0],8:[2,1],9:[2,2]}
while True:
    print('\tPlayer',d[current_player]+"'s",'chance')
    b=int(input('Enter box number: '))
    if(board[box[b][0]][box[b][1]].isalpha()):
        print("\tCELL TAKEN ALREADY TRY AGAIN",d[current_player].upper(),'YOU FOOL')
        continue
    ...
    if check_winner(board,current_player):
        if(d[non_player]=='Mahir'):
            ...
            display(board)
            print('\t',d[current_player],'wins and',d[non_player],'lost. Lol!!!!')
            break    
